...
namespace PokemonGo.RocketAPI.Helpers
{
    public class GPSOAuthClient
    {
        ...
        public string UserAgent { get; set; } = "GPSOAuthSharp/" + version;
        ...
        private async Task<Dictionary<string, string>> PerformAuthRequest(Dictionary<string, string> data)
        {
            ...
            {
                client.DefaultRequestHeaders.TryAddWithoutValidation("UserAgent", UserAgent);
                var response = await client.PostAsync<Dictionary<string, string>>(authUrl, data, null);
